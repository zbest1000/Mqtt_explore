...
export default {
  ...
  plugins: [
    ...
    // Custom plugin for MQTT-specific utilities
    function({ addUtilities }) {
      const mqttUtilities = {
        ...
        '.sparkplug-badge': {
          '@apply bg-sparkplug-100 text-sparkplug-800 border-sparkplug-200': {}
        },
        ...
        '.message-type-sparkplug': {
          '@apply bg-yellow-100 text-yellow-800': {}
        }
      }
      addUtilities(mqttUtilities)
    }
  ],
}